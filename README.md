...
#### Пример вывода
1) 
Текущее состояние: Коробка пуста
1 - Положить число
2 - Извлечь число
...
#### Пример вывода
1)
Введите координаты трехмерной точки (начало отсчета):
Координата X: 2
Координата Y: -3
Координата Z: 1
...
Сумма: 5
3)
Введите количество вложенных списков: 2
